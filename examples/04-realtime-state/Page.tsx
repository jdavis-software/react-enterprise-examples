...
import { useDevicesQuery } from './src/query/useDevicesQuery';
import { osOptions, statusOptions } from './src/generateDevices';
import './styles/_realtime.scss';
  ...
  return (
    <div>
      ...
      <footer style={{ marginTop: '0.5rem' }}>
        <Badge variant="subtle">{derivedSorted.length} shown / {devices.length} total | last batch {lastBatch} items / last flush {lastFlush.toFixed(0)}ms</Badge>
      </footer>
    </div>
  );
}
